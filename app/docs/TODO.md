...
- [ ] Move Audit table creation to its own setup-database entry.
- [ ] Build system setup on first run of new installation.
- [ ] Add user tagging to all transactions.
- [ ] Change all ID's to GUID's
